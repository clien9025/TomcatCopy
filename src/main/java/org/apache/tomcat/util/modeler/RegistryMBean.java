...
public interface RegistryMBean {
     ...
     */
    default void invoke(List<ObjectName> mbeans, String operation, boolean failFirst)
            throws Exception {
     ...
     * @since 1.1
     */
    default void registerComponent(Object bean, String oname, String type)
            throws Exception {
        throw new UnsupportedOperationException();
    }
     ...
     * @since 1.1
     */
    default void unregisterComponent(String oname) {
        throw new UnsupportedOperationException();
    }
     ...
     * @since 1.1
     */
    default int getId(String domain, String name) {
        throw new UnsupportedOperationException();
    }
