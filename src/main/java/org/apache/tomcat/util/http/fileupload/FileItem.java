...
public interface FileItem extends FileItemHeadersSupport {
     ...
     */
    default byte[] get() throws UncheckedIOException {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default String getString(String encoding) throws UnsupportedEncodingException, IOException {
        throw new UnsupportedOperationException();
    }
     ...
     *              field; {@code false} if it represents an uploaded file.
     */
    default void setFormField(boolean state) {
        throw new UnsupportedOperationException();
    }
