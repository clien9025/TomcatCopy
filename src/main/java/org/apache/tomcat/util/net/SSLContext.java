...
public interface SSLContext {
    ...
    default void init(KeyManager[] kms, TrustManager[] tms,
    ...
    default SSLSessionContext getServerSessionContext() {
        throw new UnsupportedOperationException();
    }
    ...
    default SSLServerSocketFactory getServerSocketFactory() {
        throw new UnsupportedOperationException();
    }

    default SSLParameters getSupportedSSLParameters() {
        throw new UnsupportedOperationException();
    }

    default X509Certificate[] getCertificateChain(String alias) {
        throw new UnsupportedOperationException();
    }
