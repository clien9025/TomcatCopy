...
//        return remoteAddr;
    ...
    protected void populateRemoteAddr(){throw new UnsupportedOperationException();}
...
//        endpoint.processSocket(this, socketStatus, dispatch);
    ...
    public interface CompletionCheck {
         ...
         */
        default CompletionHandlerCall callHandler(CompletionState state, ByteBuffer[] buffers,
