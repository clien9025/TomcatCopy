...
public interface SSLUtil {
    ...
    default SSLContext createSSLContext(List<String> negotiableProtocols) throws Exception {
        throw new UnsupportedOperationException();
    }

    default KeyManager[] getKeyManagers() throws Exception {
        throw new UnsupportedOperationException();
    }

    default TrustManager[] getTrustManagers() throws Exception {
        throw new UnsupportedOperationException();
    }

    default void configureSessionContext(SSLSessionContext sslSessionContext) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default String[] getEnabledProtocols() throws IllegalArgumentException {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default String[] getEnabledCiphers() throws IllegalArgumentException {
        throw new UnsupportedOperationException();
    }
    ...
    interface ProtocolInfo {
         ...
         */
        default String getNegotiatedProtocol() {
            throw new UnsupportedOperationException();
        }
    }
}
