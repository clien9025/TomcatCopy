...
public interface InstrumentableClassLoader {
     ...
     */
    default void addTransformer(ClassFileTransformer transformer) {
     ...
     */
    default void removeTransformer(ClassFileTransformer transformer) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default ClassLoader copyWithoutTransformers() {
        throw new UnsupportedOperationException();
    }
}
