...
public interface Authenticator {
     ...
     */
    default boolean authenticate(Request request, HttpServletResponse response)
            throws IOException {
        throw new UnsupportedOperationException();
    }

    default void login(String userName, String password, Request request)
            throws ServletException {
        throw new UnsupportedOperationException();
    }

    default void logout(Request request) {
        throw new UnsupportedOperationException();
    }
}
