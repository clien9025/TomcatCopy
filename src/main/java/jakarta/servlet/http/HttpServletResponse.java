...
public interface HttpServletResponse extends ServletResponse {
     ...
     * @throws IOException              If an input or output exception occurs
     * @throws IllegalArgumentException If a relative URL is given and cannot be converted into an absolute URL
     * @throws IllegalStateException    If the response was already committed when this method was called
     */
